...
func TestParse(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expected: map[string]string{
				DefaultRootName + "foo.name.value": "bar",
			},
		},
		{
			...
			expected: map[string]string{
				DefaultRootName + "foo.name.bar.value": "bar",
			},
		},
		{
			...
			expected: map[string]string{
				DefaultRootName + "foo.name1.bar.name2.value": "bar",
			},
		},
		{
		...
		},
		{
			...
			expected: map[string]string{
				DefaultRootName + "foo.caseSensitiveName": "barBoo",
			},
		},
		{
			...
			expected: map[string]string{
				DefaultRootName + "foo.Name1.bar.name2.value": "secondValue",
			},
		},
		{
		...
		},
		{
			...
			expected: map[string]string{
				DefaultRootName + "foo.default.bar.fuu": "true",
			},
		},
		{
